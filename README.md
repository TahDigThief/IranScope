...
- `regime_corruption/` - looting of the country's wealth by the elite.
- `regime_propaganda/` - disinformation networks and smear campaigns.
- `iranian_voices/` - independent survey data on Iranian public opinion.
- `iranian_safety/` - safety guidance for activists and journalists.
